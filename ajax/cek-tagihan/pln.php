...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) AND strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
    if(isset($_POST['data']) && isset($_POST['type'])) {
        ...
        if(!isset($_POST['type']) || !in_array($_POST['type'],['PLN PASCABAYAR'])) exit("No direct script access allowed!");
                      ...
                      <div class="mt-4">
                        ...
                        <div class="text-95 text-dark-m3">
                          ...
                          <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-5 col-sm-2 text-secondary-d3 text-600">
                              <b><?php echo $chresult['data']['desc']['tarif']; ?></b>
                            </div>
                          ...
                          <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-5 col-sm-2 text-secondary-d3 text-600">
                              <b><?php echo $chresult['data']['desc']['daya']; ?></b>
                            </div>
