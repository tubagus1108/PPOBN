                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <div class="page-links">
                            ...
                            <a href="<?php echo $config['web']['base_url']; ?>auth/register_agen.php" class="active">Daftar Agen</a>
                        </div>
                        </div>
                        <?php
                        ...
                        <form method="POST">
                            ...
                            <input class="form-control" type="text" name="alamat" placeholder="Alamat Lengkap Usaha" required>
