	        ...
	        <div class="card">
		        <div class="card-body">
							<a href="javascript:;" onclick="modal_open('add', '<?php echo $config['web']['base_url'] ?>admin/voucher/lib/add.php');" class="btn btn-success" style="margin-bottom: 15px"><i class="fa fa-plus-square"></i> Tambah</a>
								<h4 class="card-title"> Data Redeem Voucher</h4>
										...
										<table class="table">
											...
											?>
												<tr>
													...
													<td><?php echo $data_query['user_id'] == '0' ? '<i>NULL</i>' : ''.htmlspecialchars($user_data['rows']['username']).'' ?></td>
													<td><?php echo htmlspecialchars($data_query['voucher_code']) ?></td>
