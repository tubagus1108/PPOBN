...
<form class="form-horizontal" method="POST" id="form-add">
	...
	<div class="form-group">
		<label>API ID</label>
		<input type="text" class="form-control" name="api_id" value="<?php echo $data_target['rows']['api_id'] ?>">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label>Rate</label>
		<input type="text" class="form-control" name="rate" value="<?php echo $data_target['rows']['rate'] ?>">
	</div>
