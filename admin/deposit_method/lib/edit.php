...
<form class="form-horizontal"  method="POST" id="form">
	...
	<div class="form-group">
		...
		<select class="form-control" name="tipe_saldo">
			<option value="0">Pilih...</option>
			<option value="sosmed" <?php echo ($data_target['rows']['saldo'] == 'sosmed') ? 'selected' : '' ?>>Social Media</option>
			<option value="mobile" <?php echo ($data_target['rows']['saldo'] == 'mobile') ? 'selected' : '' ?>>PPOB</option>
		</select>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="number" class="form-control" name="bonus" value="<?php echo $data_target['rows']['bonus'] ?>">
	</div>
