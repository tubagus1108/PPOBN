...
<div class="header-large-title pt-5"><header class="no-border text-light">
    <left>
        <a href="/" class="headerButton">
            ...
            <pagetitle>Top Up Games</pagetitle>
        </a>
    </left>
    <right></right>
</header></div>
      ...
      <card style="border-radius: .90rem">
          <card-body style="padding-top: 6px; padding-bottom: 6px">
            <div class="form-group">
                <div class="form-group">
                    <label>Masukkan User ID (Lainnya)</label>
                ...
                <select style="border-radius: .40rem" class="form-control" id="oprator" name="service">
                    ...
                    <?php
                    $category = $model->db_query($db, "*", "service_type", "type = 'Games'", "name ASC");
                    if ($category['count'] == 1) {
    ...
    $(document).ready(function() {
        ...
        $("#oprator").change(function() {
            ...
            $.ajax({
                ...
                data: 'oprator=' + oprator + '&type=Games' + '&phone=' + phone,
                type: 'POST',
                dataType: 'html',
...
<div class="col-lg-12">
	<div class="iq-card">
		<div class="iq-card-body">
            ...
            <ul>
             <li>Masukkan User ID (Lainnya) Terlebih Dahulu.</li>
