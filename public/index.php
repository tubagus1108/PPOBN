...
<section class="pt-2 wd-100">
    <div id="carouselExampleCaptions" style="border-radius: 9px;margin-top:60px;" class="carousel slide" data-ride="carousel">
...
<? } ?>
<section class="pt-2 wd-100">
    <div class="col-lg-12 pull-left" style="margin: 15px 0; margin-left: -15px;">
		<b>Prabayar</b>
	</div>
    <div class="row mt-3">
        ...
        <div class="_1ekcz mt-1" style="width: 100%;">
            ...
            <div class="_24EoF">
                <a style="text-decoration:none" href="javascript:;" onclick="javascript:location.href='<?php echo $config['web']['base_url']; ?>tagihan/gas'">
                    <div class="avatar avatar-40 no-shadow border-0">
                        <div class="overlay gradient-primary"><img class="img-fluid" src="<?php echo $config['web']['base_url']; ?>dist/images/pgn1.png" alt="Paket Data" style="height: 30px;"></div>
                    </div>
                    <br />
