...
<div class="table-responsive">
	<table class="table table-bordered">
		...
		<tr>
			<td>API KEY</td>
			<td><?php echo $login['api_key'] ?> <a href="<?php echo $config['web']['base_url'] ?>user/post-settings.php?action=api_key" class="btn btn-xs btn-info" title="Buat ulang">Buat ulang</a></td>
		</tr>
		<tr>
			<td>CONTOH CLASS</td>
